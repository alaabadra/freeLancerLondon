...
export default class OfferDetails extends Component {
  ...
  render() {
    ...
    );//to insure is he owner offer or not
    //this show  wether owner or not 
    return (//(first row contain 2 col1 =>position,title ,col2=> status )
      <Container className="page__container">
        ...
        {/* second row =>2 col: 1col =>desc ,2col=>skills , offer_type */}
        ...
        {/* note that all prev info from offer.js(because info about offer) but here now info about applicatns from application.js */}
        {/* third row  */}
        {/* if owner => show applicants(proposals that it from persons that they come on in this offer) */}
